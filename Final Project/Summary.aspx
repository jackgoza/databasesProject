		...
		<div id="container" class="container">
				...
				<div id="pageContent" class="row">
					...
					<div id="content" class="col-xs-10">
						...
						<canvas id="graphcanvas" height ="256" width ="256" style="display: block; margin: 0 auto;"></canvas> <br/>
							...
							<div class="col-xs-12 itemContent" runat="server">
								...
								<div class="col-xs-12">
									<div class="col-xs-9 textLeft">
										<p>Manage this budget on the budgets page.</p>
									</div>
									<div class="col-xs-3">
										<div id="goToBudgetsBtn" class="darkBtn textCenter"><p>Go to Budgets</p></div>
									</div>
								</div>
							</div>
						</ItemTemplate>
